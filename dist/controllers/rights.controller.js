...
exports.GetListRights = GetListRights;
exports.GetRightQuestions = GetRightQuestions;
const mongodb_1 = require("mongodb");
const uri = process.env.MONGO_DB_URL || "";
const client = new mongodb_1.MongoClient(uri);
function GetListRights(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const categoryKeys = categories.map(category => {
                const { _id } = category, rest = __rest(category, ["_id"]);
...
function GetRightQuestions(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield client.connect();
            const db = client.db("namma_rights");
